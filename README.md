[english study.index.html](https://github.com/user-attachments/files/28297799/english.study.index.html)
<!DOCTYPE html>
<html lang="ko">
<head>
<meta charset="UTF-8">
...
let curUser='',curCat=null,studyWords=[],studyIdx=0,quizWords=[],quizIdx=0,quizScore=0,wrongWords=[];
...
function saveRecord(u,rec){const db=getDB();if(!db[u])db[u]={records:[]};db[u].records.push(rec);saveDB(db);}
